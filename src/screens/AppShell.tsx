...
export function AppShell({ onSignOut }: Props) {
	...
	const [sensorId, setSensorId] = useState("30000_TL208");
	...
	const content = (() => {
		switch (page) {
			case "Dashboard":
				return <DashboardPage onOpenActivity={() => go("ActivityFeed")} onOpenSensor={() => openSensor("30000_TL208")} />;
			case "SensorNetwork":
