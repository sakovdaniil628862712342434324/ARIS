	...
	return (
		<View style={styles.wrap}>
			<View style={styles.header}>
				...
				<Text style={styles.subtitle}>Live building intelligence · ARIS adaptive HVAC control</Text>
			</View>
			...
			<View style={[styles.row, compact && styles.col]}>
				<View style={[styles.card, styles.half, compact && styles.full]}>
					...
					{ALERTS.map((a) => (
						<Pressable key={a.title} style={styles.alertItem} onPress={a.title.includes("HRV1") ? onOpenSensor : undefined}>
